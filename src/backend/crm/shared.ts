...
export function normalizeLead(row: Lead): Lead {
  return {
    ...
    email_engagement: row.email_engagement ?? 'none',
    last_email_opened_at: row.last_email_opened_at ?? null,
    total_email_opens: Number(row.total_email_opens ?? 0),
    last_email_clicked_at: row.last_email_clicked_at ?? null,
